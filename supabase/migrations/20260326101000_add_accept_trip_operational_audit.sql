...
BEGIN
  ...
  IF NOT FOUND THEN
    INSERT INTO operational_events(domain, action, status, entity_id, actor_user_id, metadata)
    VALUES ('TRIP_ACCEPTANCE', 'ACCEPT_TRIP', 'REJECTED', p_trip_id, v_user_id, jsonb_build_object('code', 'DRIVER_NOT_FOUND'));
  ...
  IF v_driver_status.status <> 'ACTIVE' THEN
    INSERT INTO operational_events(domain, action, status, entity_id, actor_user_id, metadata)
    VALUES ('TRIP_ACCEPTANCE', 'ACCEPT_TRIP', 'REJECTED', p_trip_id, v_user_id, jsonb_build_object('code', 'DRIVER_NOT_ACTIVE', 'driver_id', v_driver_id));
  ...
  IF NOT v_driver_status.can_receive_trips OR NOT v_driver_status.is_online THEN
    INSERT INTO operational_events(domain, action, status, entity_id, actor_user_id, metadata)
    VALUES ('TRIP_ACCEPTANCE', 'ACCEPT_TRIP', 'REJECTED', p_trip_id, v_user_id, jsonb_build_object('code', 'DRIVER_NOT_ENABLED', 'driver_id', v_driver_id));
  ...
  IF v_driver_status.is_on_trip THEN
    INSERT INTO operational_events(domain, action, status, entity_id, actor_user_id, metadata)
    VALUES ('TRIP_ACCEPTANCE', 'ACCEPT_TRIP', 'REJECTED', p_trip_id, v_user_id, jsonb_build_object('code', 'DRIVER_ALREADY_ON_TRIP', 'driver_id', v_driver_id));
  ...
  IF NOT FOUND THEN
    ...
    IF NOT FOUND THEN
      INSERT INTO operational_events(domain, action, status, entity_id, actor_user_id, metadata)
      VALUES ('TRIP_ACCEPTANCE', 'ACCEPT_TRIP', 'FAILED', p_trip_id, v_user_id, jsonb_build_object('code', 'TRIP_NOT_FOUND', 'driver_id', v_driver_id));
    ...
    IF v_trip_status.driver_id IS NOT NULL OR v_trip_status.status <> 'REQUESTED' THEN
      INSERT INTO operational_events(domain, action, status, entity_id, actor_user_id, metadata)
      VALUES ('TRIP_ACCEPTANCE', 'ACCEPT_TRIP', 'REJECTED', p_trip_id, v_user_id, jsonb_build_object('code', 'TRIP_ALREADY_TAKEN', 'driver_id', v_driver_id));
    ...
    INSERT INTO operational_events(domain, action, status, entity_id, actor_user_id, metadata)
    VALUES ('TRIP_ACCEPTANCE', 'ACCEPT_TRIP', 'REJECTED', p_trip_id, v_user_id, jsonb_build_object('code', 'TRIP_STATE_INVALID', 'driver_id', v_driver_id));
  ...
  INSERT INTO operational_events(domain, action, status, entity_id, actor_user_id, metadata)
  VALUES ('TRIP_ACCEPTANCE', 'ACCEPT_TRIP', 'SUCCESS', v_trip_status.id, v_user_id, jsonb_build_object('driver_id', v_driver_id));
